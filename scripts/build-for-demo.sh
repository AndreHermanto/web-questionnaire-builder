...
REACT_APP_BASE_URL=https://uat.genome.one/api/gw-$clean_app_name/v1 REACT_APP_PASSPORT_URL=/demo/uat/web-passport/develop CI=true npm run build 2> >(tee build.txt >&2)
mkdir -p $branch_name
cp -R build/* $branch_name
